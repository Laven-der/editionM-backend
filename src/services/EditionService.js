...
const model = require("../models/Edition");
module.exports.getEditionLists = () => {
    return model.find({}).then(docs => docs)
        .catch(e => {
            throw e;
        });
};
module.exports.updateEditionItem = (_id, dataObj) => {
    console.log(dataObj)
    return model
        .update(
            { '_id': _id },
...
module.exports.addEditionItem = (data) => {
    return model
        .create(data).then(docs => {
            return docs;
        })
        .catch(e => {
            throw e;
...
module.exports.deleteEditionItem = (_id) => {
    return model.remove({ "_id": _id }).then(docs => docs)
        .catch(e => {
            throw e;
        });
};
